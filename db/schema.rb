...
ActiveRecord::Schema.define(version: 20170826223803) do
  ...
  create_table "certificates", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "code"
